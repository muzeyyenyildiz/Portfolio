            ...
            <Row className="justify-content-center">
                <Row className="justify-content-center">
                    ...
                    <Col md={6} className="mb-4">
                        <Card className="h-100 shadow-sm text-center">
                            <Card.Body>
                                <Card.Title className="text-primary">Telefon</Card.Title>
                                <Card.Text>
                                    <a href={`https://wa.me/${content.contact.phone}`} target="_blank" rel="noopener noreferrer" className="text-decoration-none">{content.contact.phone}</a>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
